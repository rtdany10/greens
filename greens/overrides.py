...
from frappe.utils import cint, date_diff, flt, getdate, month_diff, today
...
class CustomSalarySlip(SalarySlip):
    ...
    def custom_set_working_hours(self):
        ...
        self.total_working = overtime[0]["working_hours"]
